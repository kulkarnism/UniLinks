...
public class UniversityObject {
	...
	private Date springApplnDate,fallApplnDate;
	private long greScore,toeflScore,ieltsScore;


	public UniversityObject(String schoolName, String tuitionFees,
			String location, String contact, String department,
			Date springApplnDate, Date fallApplnDate, long greScore,
	...
	public Date getSpringApplnDate() {
		return springApplnDate;
	}


	public void setSpringApplnDate(Date springApplnDate) {
		this.springApplnDate = springApplnDate;
	}


	public Date getFallApplnDate() {
		return fallApplnDate;
	}


	public void setFallApplnDate(Date fallApplnDate) {
		this.fallApplnDate = fallApplnDate;
	}
